...
function drawTriangles() {
	coords = new Float32Array(len*9)
	colors = new Float32Array(len*9)
	normals = new Float32Array(len*9)
	...
	while(traverseStack.length > 0) {
		...
		// mat4.rotateY(transform, transform, Math.PI/2 + (Math.PI*1.5)*f)
		...
		var r = lerp(0.8, 0.2, Math.min(dist/30, 1))
		var g = r
		var b = r
